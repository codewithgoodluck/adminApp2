...
function ApplicationsTablePage() {
  ...
  return (
    <section className='mx-10 ' >
        <div className="text-lg font-bold mt-10 mb-2 ">Available Applications</div>
        <hr></hr>
    <TableContainer   >
      ...
      <Table>
        <TableHead className='bg-[#E3F0FF] '>
          <TableRow>
            ...
            <TableCell style={{width: '10%'}} style={{ fontWeight: 600 }} >Application Name</TableCell>
