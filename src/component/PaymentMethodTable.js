...
function PaymentMethodTable() {
  ...
  return (
    <section className='mx-10 ' >
        <div className="text-lg font-bold mt-10 mb-2 ">Payment Method Information</div>
        <hr></hr>
    <TableContainer   >
      ...
      <Table>
        <TableHead className='bg-[#E3F0FF] '>
          <TableRow>
            <TableCell style={{width: '10%'}}  style={{ fontWeight: 600 }}>Payment Method</TableCell>
            <TableCell style={{width: '10%'}} style={{ fontWeight: 600 }} >Minimum Amount</TableCell>
            <TableCell style={{width: '10%'}} style={{ fontWeight: 600 }} >Status</TableCell>
